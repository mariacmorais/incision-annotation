...
index 2ecdccb980bc10a27cd1a04c22c4a7df363d4a18..94276299ed1ae60803524e2a74cb8d9194be92a8 100644
--- a/app.js
+++ b/app.js
...
@@ -263,189 +267,200 @@ function prepareHelperVideo() {
...
+  const success = captureFrameImage(helperVideo, helperVideo.currentTime, false);
   if (success) {
     teardownHelperVideo();
   } else {
     handleHelperError();
